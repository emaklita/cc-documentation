...
You can update through add-on's dashboard in the [Clever Cloud Console](https://console.clever-cloud.com). You can also set `CC_OTOROSHI_VERSION` of the underlying Java application to `v17.9.1_1764663014` and rebuild it, or use [Clever Tools](/doc/cli/operators/):
...
clever otoroshi version update yourOtoroshiNameOrId v17.9.1_1764663014
```
